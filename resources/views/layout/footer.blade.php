      ...
      <div class="row w3_agile-footer-grids py-5">
        <div class="col-lg-2 col-sm-3 mb-sm-0 mb-4 px-sm-0 px-4 w3_agile-footer1 f1"> 
          <h5 class="mb-3">Useful Links </h5>
            ...
            <li><a href="/">Home</a></li>
            <li><a href="/islamic_home">Islamic Article</a></li>
            <li><a href="/love_home">Love Article</a></li>
        ...
        <div class="col-lg-7 col-sm-9 mb-sm-0 mb-4 px-sm-0 px-4 row w3_agile-footer1 f2">
          ...
          <div class="col-lg-6 col-sm-7  mb-sm-0 mb-4 inner-li">
            ...
            <ul class="w3ls-footer-bottom-list">
              <li> <span class="fas fa-map-marker"></span>Jl Anjasmoro no 45<span><br>Lawang, Malang</span></li>
              <li> <span class="fas fa-envelope"></span> <a href="mailto:name@example.com">nuzulristyantikay@gmail.com</a> </li>
              <li> <span class="fas fa-phone"></span>08984475379</li>
            </ul>
          </div>
        ...
        <div class="col-lg-3 col-md-12 px-sm-0 px-4 w3_agile-footer1 f3">
          ...
          <ul class="tweet-agile">
            <li>
              <p class="tweet-p1"><span class="" aria-hidden="true"></span>Line : nuzulristyantika</p>
            </li>
            <li>
              <p class="tweet-p1"><span class="" aria-hidden="true"></span>Facebook : Nuzul Ristyantika</p>
            </li>
            <li>
              <p class="tweet-p1"><span class="" aria-hidden="true"></span>Instagram : @ristyantika</p>
            </li>
            <li>
              <p class="tweet-p1"><span class="" aria-hidden="true"></span>LinkedIn : nuzul ristyantika</p>
            </li>
          </ul>
        </div>
      </div>
