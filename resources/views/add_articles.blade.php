...
<div class="container">
   <form action="{{ URL::to('add_articles')}}" method="post" enctype="multipart/form-data" class="form-image-upload">
        ...
        <div class="row" style="margin-top: 3%; margin-left: 10%">
          <div class="col-sm-4">
                 <!--  <img style="max-width:180px;" id="blah" src="http://placehold.it/180" alt="your image" />
                  <input type="file" name="image_article" style="margin-top: 10%; padding:10px;background:#2d2d2d;" id="file" class="form-control" onchange="readURL(this);"> -->
          ...
          <div class="col-sm-8">
            ...
            <div class="form-group">
             ...
             <textarea type="text" class="form-control" placeholder="" name="description_article" id="" required="" rows="10000"></textarea>
            </div>
            <div>
