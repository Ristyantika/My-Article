  ...
  <div class="container-fluid py-lg-5 py-3">
    <div class="row about_grids">
      ...
      <div class="col-lg-4 col-md-6 team_grid1" style="margin-left: 5%">
        <h3 class="heading text-uppercase">WRITE YOUR ISLAMIC ARTICLE</h3>
      </div>  
    </div>
  </div>
</section>
    ...
    @foreach($islamics as $islamic)
      <div class="col-lg-2 col-md-3 col-6 mb-md-0 mb-5 w3l_team_grid">
        <div class="view view-second" style="width: 100px; margin-left: 60px">
            <img src="{{asset("images/$islamic->image_article")}}" alt=" " class="img-fluid" />
        </div>
        <h4 class="my-2">{{$islamic->title_article}}</h4>
        <form action="{{url("islamic_home/$islamic->id_article")}}">
